    ...
    children: [
      ...
      //? RANKING
      {
        ...
        children: [
          ...
          //   name: 'charts',
          //   path: 'charts',
          //   component: () => import('../pages/admin/ranking/charts/Charts.vue'),
          //   meta: {
          ...
          //   name: 'progress-bars',
          //   path: 'progress-bars',
          //   component: () => import('../pages/admin/ranking/progress-bars/ProgressBars.vue'),
          //   meta: {
      ...
      },
      {
        ...
        children: [
          ...
          //   name: 'markup',
          //   path: 'markup',
          //   component: () => import('../pages/admin/comparator/markup-tables/MarkupTables.vue'),
          //   meta: {
          ...
          //   name: 'data',
          //   path: 'data',
          //   component: () => import('../pages/admin/comparator/data-tables/DataTables.vue'),
          //   meta: {
          //     wikiLink: 'https://github.com/epicmaxco/vuestic-admin/wiki/Tables',
          //   },
          // },
